...
/**
 * Title: Page Title
 * Slug: history-museum/page-title
 * Categories: history-museum, page-title
 */
?>

<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() . '/images/inner-banner.png'); ?>","id":6,"dimRatio":50,"minHeight":300,"isDark":false} -->
