...
/**
 * Title: Latest News
 * Slug: history-museum/latest-news
 * Categories: history-museum, latest-news
 */
?>
...
<h4 class="wp-block-heading has-text-align-center section_sub_title has-primary-color has-text-color" style="font-size:20px;font-style:normal;font-weight:500"><?php esc_html_e('Recent News','history-museum'); ?></h4>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading has-text-align-center section_title has-big-font-size" style="margin-top:0px"><?php esc_html_e('Our Latest News','history-museum'); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"var:preset|spacing|80","right":"var:preset|spacing|80"},"margin":{"right":"var:preset|spacing|80","left":"var:preset|spacing|80"}}}} -->
<p class="has-text-align-center" style="margin-right:var(--wp--preset--spacing--80);margin-left:var(--wp--preset--spacing--80);padding-top:0;padding-right:var(--wp--preset--spacing--80);padding-bottom:0;padding-left:var(--wp--preset--spacing--80)"><?php esc_html_e('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.','history-museum'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p><?php esc_html_e('There is no post found','history-museum'); ?></p>
<!-- /wp:paragraph -->
